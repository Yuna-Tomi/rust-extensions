...
func (s *service) Create(ctx context.Context, r *taskAPI.CreateTaskRequest) (_ *taskAPI.CreateTaskResponse, err error) {
	// // dbg(logfile_service, "service.Create called.")
	s.mu.Lock()
	defer s.mu.Unlock()

	// dbg(logfile_service, "call NewContainer...")
...
func (s *service) Delete(ctx context.Context, r *taskAPI.DeleteRequest) (*taskAPI.DeleteResponse, error) {
	// dbg(logfile_service, "service.Delete called.")
	container, err := s.getContainer(r.ID)
	if err != nil {
		return nil, err
	}
...
func (s *service) Exec(ctx context.Context, r *taskAPI.ExecProcessRequest) (*ptypes.Empty, error) {
	// dbg(logfile_service, "service.Exec called.")
	return nil, errdefs.ToGRPC(fmt.Errorf("unimplemented"))
	// container, err := s.getContainer(r.ID)
	// if err != nil {
	// 	return nil, err
	// }
...
func (s *service) State(ctx context.Context, r *taskAPI.StateRequest) (*taskAPI.StateResponse, error) {
	// dbg(logfile_service, "service.State called.")
	container, err := s.getContainer(r.ID)
	if err != nil {
		return nil, err
	}
...
func (s *service) Pause(ctx context.Context, r *taskAPI.PauseRequest) (*ptypes.Empty, error) {
	// dbg(logfile_service, "service.Pause called.")
	return nil, errdefs.ToGRPC(fmt.Errorf("unimplemented"))
	// container, err := s.getContainer(r.ID)
	// if err != nil {
	// 	return nil, err
...
func (s *service) Kill(ctx context.Context, r *taskAPI.KillRequest) (*ptypes.Empty, error) {
	// dbg(logfile_service, "service.Kill called.")
	container, err := s.getContainer(r.ID)
	if err != nil {
		return nil, err
	}
...
func (s *service) Pids(ctx context.Context, r *taskAPI.PidsRequest) (*taskAPI.PidsResponse, error) {
	// dbg(logfile_service, "service.Pids called.")
	return nil, errdefs.ToGRPC(fmt.Errorf("unimplemented"))
	// container, err := s.getContainer(r.ID)
	// if err != nil {
	// 	return nil, err
...
func (s *service) Wait(ctx context.Context, r *taskAPI.WaitRequest) (*taskAPI.WaitResponse, error) {
	// dbg(logfile_service, "service.Wait called.")
	container, err := s.getContainer(r.ID)
	if err != nil {
		return nil, err
	}
...
func (s *service) Connect(ctx context.Context, r *taskAPI.ConnectRequest) (*taskAPI.ConnectResponse, error) {
	// dbg(logfile_service, "service.Connect called.")
	var pid int
...
func (s *service) Shutdown(ctx context.Context, r *taskAPI.ShutdownRequest) (*ptypes.Empty, error) {
	// dbg(logfile_service, "service.Shutdown called.")
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *service) Stats(ctx context.Context, r *taskAPI.StatsRequest) (*taskAPI.StatsResponse, error) {
	// dbg(logfile_service, "service.Stats called.")
	return nil, errdefs.ToGRPC(fmt.Errorf("unimplemented"))
	// container, err := s.getContainer(r.ID)
	// if err != nil {
	// 	return nil, err
