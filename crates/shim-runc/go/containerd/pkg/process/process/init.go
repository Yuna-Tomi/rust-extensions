...
func NewRunc(root, path, namespace, runtime, criu string, systemd bool) *runc.Runc {
	// dbg(logfile_init, "NewRunc called.")
	if root == "" {
		root = RuncRoot
	}
	return &runc.Runc{
...
// const logfile_init = "/home/ytomida.linux/nerd_dev/rust-extensions/crates/.mydebug/init.go.log"
...
func (p *Init) Create(ctx context.Context, r *CreateConfig) error {
	...
	if p.io != nil {
		// dbg(logfile_init, "IO set")
		opts.IO = p.io.IO()
	}
	// if socket != nil {
	// 	// dbg(logfile_init, "socket set")
